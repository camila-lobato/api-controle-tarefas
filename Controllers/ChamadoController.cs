...
namespace ApiServico.Controllers
{
    ...
    public class ChamadoController : ControllerBase
    {
        ...
        {
            var chamado = ListaChamados.FirstOrDefault(item => item.Id == id);
        ...
        [HttpPut("{id}")]
        public IActionResult Atualizacao(int id, [FromBody] ChamadoDto novoChamado)
        {
            var chamado = ListaChamados.FirstOrDefault(item => item.Id == id);
        ...
        public IActionResult AtualizacaoStatus(int id)
        {
            var chamado = ListaChamados.FirstOrDefault(item => item.Id == id);
